...
export const Main = () => {
    ...
    const [areNewsShown, setAreNewsShown] = useState(false);

    const toggleNewsHandler = () => {
        setAreNewsShown(areNewsShown => !areNewsShown);
    }
    ...
    return(
        <QueryClientProvider client={queryClient}>
            <StyledMain >
                {isOpened && <SettingsSidebar onChange={toggleNewsHandler}/>}
                <div className="header__wrapper">
                    <h1 className="header__title">To Do</h1>
                    <CoveredButton width="35px" height="35px" onClick={toggleClickHandler} isOpened={areNewsShown} movable={false}>
                        <svg className="header__settingsButton" width="29" height="30" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg" role='img' aria-label="app settings">
